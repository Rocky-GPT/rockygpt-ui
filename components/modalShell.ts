...
export const MODAL_PANEL =
  'relative w-full max-w-4xl h-[85vh] flex flex-col bg-background rounded-2xl border border-border shadow-2xl animate-in zoom-in-95 duration-200 overflow-hidden';
 ...
 * family, but the height hugs the content instead of being pinned to 85vh —
 * a fixed height on a few phone numbers leaves half the panel empty.
 */
export const MODAL_PANEL_SHORT =
  'relative w-full max-w-4xl max-h-[85vh] flex flex-col bg-background rounded-2xl border border-border shadow-2xl animate-in zoom-in-95 duration-200 overflow-hidden';
